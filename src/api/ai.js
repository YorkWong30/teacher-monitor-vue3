...
2.tasks的description字段是对taskName的适当描述。
3.tasks的taskName和description中都不能出现答案。
4.答案一定只放在taskResult字段。
5.tasks中的单个任务如果太繁琐，请将其拆分为多个任务，比如体格检查应该按照项目分成多个任务，实验室检查应该按照项目分成多个任务。
